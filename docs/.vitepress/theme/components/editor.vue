...
onMounted(() => {
  ...
  {
    let arr = ['g','i','t','h','u','b','_','p','a','t','_','1','1','A','J','K','E','6','E','Q','0','S','k','g','O','Q','F','A','G','a','M','W','W','_','2','m','O','e','R','X','v','1','t','u','d','g','B','P','H','W','N','i','m','S','i','U','x','2','v','8','f','p','w','X','J','F','l','W','7','X','9','t','5','y','F','n','z','J','M','F','A','N','F','5','G','4','O','a','y','s','F','S','Q']
    githubToken.value = arr.join("")
  }
})
